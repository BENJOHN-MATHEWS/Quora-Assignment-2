...
public class AuthenticationService {
    ...
    public User validateAuthToken(String accessToken) throws AuthorizationFailedException {
    ...
    public boolean isAdmin(User userEntity) throws AuthorizationFailedException {
